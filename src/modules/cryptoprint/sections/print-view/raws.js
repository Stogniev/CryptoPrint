...
var svgtemplate_front_data="",
  ...
  get('https://shimon.doodkin.com/files/Layer%202%20-%20Phase%203%20-%20Front%20Data%20Placeholders.svg')
  .then(function( data){    svgtemplate_front_data=data;  console.log('svgtemplate_front_data done'); get_done(); })
  .catch(function(e){  console.log(e)  });

  get('https://shimon.doodkin.com/files/Layer%201%20-%20On%20Transparent%20Placeholders.svg')
  ...
  get('https://shimon.doodkin.com/files/Layer%202%20-%20Phase%201%20-%20Back%20Artwork.svg')
  .then(function( data){     svgtemplate_back_artwork=data;  console.log('svgtemplate_back_artwork done'); get_done(); })
  .catch(function(e){ console.log(e) });

  get('https://shimon.doodkin.com/files/Layer%202%20-%20Phase%202%20-%20Front%20Artwork.svg')
    ...
    for (var c = 0; c < m; c += 1) {
      for (var j = 0; j < dotzize; j += 1) {
        for (var k = 0; k < dotzize; k += 1) {
         ...
         {
           if(qr.isDark(r, c))setPixel1(imageData, xx+k  , y+j, rr, gg, bb, 255);
         }
        }
      }
      xx+=dotzize;
